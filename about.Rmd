...
## Evaluation of the European COVID-19 Modelling Hubs

In late 2022 we have run an evaluation of the European COVID-19 Forecast Hub, European COVID-19 Scenario Hub, and the European Modelling Hub meetings, using a survey sent to all participants of the Hub. The results and presentation of the evaluation can be found below.

```{r evaluations, results='asis', echo=FALSE}
files <- rev(fs::dir_ls("evaluations"))
